...
Il portfolio è una **web app responsive** sviluppata con **React \+ TypeScript \+ TailwindCSS**, progettata per offrire un’esperienza moderna, veloce e intuitiva.  
 Contiene sezioni dedicate alla mia **biografia**, ai **progetti full-stack**, agli **articoli tecnici**, e a una **pagina contatti** completamente interattiva.
...
| Sezione | Descrizione |
| ----- | ----- |
| 🏠 **Home** | Introduzione, Hero section e Call-to-Action verso Contatti e Progetti |
| 👩‍💻 **Chi Sono** | Breve biografia, percorso e competenze principali |
| 🚀 **Progetti** | Lista dinamica di progetti con link GitHub e demo live |
| 📝 **Blog** | Articoli tecnici collegati a Contentful, con filtri e tag |
| 📈 **Statistiche** | Panoramica della mia crescita professionale e delle attività |
| 📬 **Contatti** | Modulo funzionante via Nodemailer/EmailJS \+ link diretti a LinkedIn, Email e WhatsApp |
...
Questo progetto è distribuito con licenza **MIT**, liberamente consultabile e riutilizzabile con attribuzione.
