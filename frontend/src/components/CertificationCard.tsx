...
import { Calendar, Building, Mail, FileText } from 'lucide-react';
...
const CertificationCard: React.FC<CertificationCardProps> = ({
  ...
  const gradientClass = icon === 'GraduationCap' 
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <motion.button
            ...
            className={`flex-1 inline-flex items-center justify-center px-4 py-3 bg-linear-to-r ${gradientClass} text-white font-semibold rounded-lg hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-violet-500/30`}
          >
